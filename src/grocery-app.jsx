...
const FORECAST_LAT = 39.48824;            // configure for your location (default: generic US point)
const FORECAST_LON = 75.68890;
...
function getMealSuggestions(awayHome, meals, days, effortMap, alreadyPlanned = [], recentMeals = [], seenThisSession = [], dayPills = {}, forecast = {}) {
  ...
  const favScore = m => {
    ...
    const jamesLike = prefs.some(p => p.person === "Me" && p.pref === "likes") ? 0.5 : 0;
